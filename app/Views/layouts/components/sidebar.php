<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
    ...
    <div class="sidebar-brand-text mx-3">Kita bantu masyarakat</div>
  </a>
  <!-- Divider -->
  ...
  ?>
    <li class="nav-item">
      ...
      <div class="collapse" id="collapse2" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="/lapor">Laporan</a>
        </div>
      </div>
    </li>
  <?php
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="collapse2" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">Custom Components</h6>
          <a class="collapse-item" href="/pengaduan">Pengaduan</a>
          <a class="collapse-item" href="/pengaduanmasya">Tulis Pengaduan</a>
        </div>
      </div>
    </li>
  <?php
  ...
  <!-- <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/pengaduan">Pengaduan</a>
            <a class="collapse-item" href="/pengaduanmasya">Lihat Laporan</a>
          </div>
        </div>
      </li> -->
